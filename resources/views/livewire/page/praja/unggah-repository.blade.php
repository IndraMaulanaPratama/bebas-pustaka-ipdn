...
<div class="row">
    ...
    <div class="row g-4">
        <div class="col-lg-12 col-md-12 col-sm-12">
            <x-admin.components.card.card size=12 title='Data Pengajuan' titleSpan='Unggah Repository'>
                ...
                <x-admin.components.tabs.tab-content id="myTabjustified">
                    <x-admin.components.tabs.content active="active" id="tab-1">
                        @livewire('Praja.UnggahRepository.Pengajuan', [], key('form'))
                    </x-admin.components.tabs.content>

                    <x-admin.components.tabs.content id="tab-2">
                        @livewire('Praja.UnggahRepository.Resume', [], key('table'))
