                ...
                <table class="table table-responsive table-hover">
                    ...
                    <tbody>
                        @foreach ($pustaka as $item)
                            ...
                            <tr>
                                <td> {{ $loop->index + $pustaka->firstItem() }} </td>
                                ...
                                <td>
                                    <button type="button" class="btn btn-link"
                                        wire:click="detailPraja('{{ $item->PUSTAKA_PRAJA }}')" data-bs-toggle="modal"
                                ...
                                <td> {{ $item->PUSTAKA_TANGGAL_PENGAJUAN ? $item->PUSTAKA_TANGGAL_PENGAJUAN->locale('id')->translatedFormat('d M Y H:i') : '-' }} </td>
                                <td> {{ $item->PUSTAKA_OFFICER === 1 ? null : $item->user->name }} </td>
                                <td> {{ $item->PUSTAKA_APPROVED ? \Carbon\Carbon::parse($item->PUSTAKA_APPROVED)->locale('id')->translatedFormat('d M Y H:i') : '-' }} </td>
                                ...
                                <td {{ $buttonClasses['print'] }}>
                                    <button type="button"
                                        ...
                                        wire:confirm='Cetak Bukti Donasi {{ $item->PUSTAKA_PRAJA }} ?'
