                        ...
                        @foreach ($data as $item)
                            @php
                                $buttonClasses = $this->getButtonStatus(
                                    $item->PEMUSTAKA_STATUS,
                                    $item->PEMUSTAKA_OFFICER,
                                );
                            @endphp
                            ...
                            <tr>
                                ...
                                <td>
                                    <button type="button" class="btn btn-link"
                                        wire:click="detailPraja('{{ $item->PEMUSTAKA_PRAJA }}')" data-bs-toggle="modal"
                                        data-bs-target="#modalDetailPraja">
                                        {{ $item->PEMUSTAKA_PRAJA }}
                                    </button>
                                </td>
                                ...
                                <td {{ $buttonClasses['keep'] }}>
                                    <button type="button"
                                        ...
                                        wire:click='keepData("{{ $item->PEMUSTAKA_ID }}")'>
                                ...
                                <td {{ $buttonClasses['approve'] }}>
                                    <button type="button"
                                        ...
                                        wire:click='approveData("{{ $item->PEMUSTAKA_ID }}")'>
                                ...
                                <td {{ $buttonClasses['reject'] }}>
                                    <button type="button"
                                        ...
                                        wire:click='rejectData("{{ $item->PEMUSTAKA_ID }}")'>
                                ...
                                <td hidden >
                                    <button type="button"
                                        ...
                                        wire:click='printApprooved("{{ $item->PEMUSTAKA_ID }}")'>
