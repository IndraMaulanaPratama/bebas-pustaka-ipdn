...
<div class="col-12">
    <div class="row collapse" id="formLiterasi" wire:ignore>

        {{-- Pengaturan Literasi --}}
        <div class="col-lg-6 col-md-6 col-sm-12">
            <x-admin.components.card.card size=12 title="Pengaturan Formulir Literasi">
                ...
                <ul>
                    ...
                    <li>
                        ...
                        <p>
                            ...
                            <a href="#" data-bs-toggle="collapse" data-bs-target="#updateLiterasi"
                                aria-expanded="false" aria-controls="updateLiterasi" class="btn btn-link btn-sm">
                                Ubah URL Formulir
                            </a>
                        </p>
                    </li>
        ...
        {{-- Form ubah URL Literasi --}}
        <div class="col-lg-6 col-md-6 col-sm-12 collapse" id="updateLiterasi">
            <x-admin.components.card.card size=12 title="Ubah URL Literasi">

                <form wire:submit='updateUrl' method="POST">
                    <div class="row g-2">
                        <div>
                            <x-admin.components.form.input name="inputUrl" placeholder="URL Formulir Literasi" />
                        </div>
                        ...
                        <div>
                            ...
                            <a href="#" data-bs-toggle="collapse" data-bs-target="#updateLiterasi"
                                aria-expanded="false" aria-controls="updateLiterasi" class="btn btn-outline-secondary"
    ...
    <div>
        <x-admin.components.card.card size=12 title="Data Pengajuan" titleSpan='Aktif'>
            ...
            <div class="row d-flex bd-highlight g-4">
                ...
                {{-- Button Formulir Literasi --}}
                <div class="w-auto bd-highlight" {{ $accessUpdate }}>
                    <div data-bs-toggle="collapse" data-bs-target="#formLiterasi" aria-expanded="false"
                        aria-controls="formLiterasi">
                        <x-admin.components.button.icon-button color="info" icon="bi-card-list"
                            text="Formulir Literasi" :access=$accessUpdate />
                    </div>
                </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <button type="button" class="btn btn-link"
                                        wire:click="detailPraja('{{ $item->KONTEN_PRAJA }}')" data-bs-toggle="modal"
                                ...
                                <td>
                                    <a href="{{ $item->KONTEN_URL }}" target="blank" class="btn btn-link">
                                        Buka tautan <sup><i class="bi bi-arrow-up-right-circle"></i></sup>
                                    </a>
                                </td>
                                ...
                                <td {{ $buttonApprove }}>
                                    <button type="button"
                                        ...
                                        wire:click='approveData("{{ $item->KONTEN_ID }}")'>
            ...
            <x-admin.tamplates.paginate.paginate :item="$konten" />
