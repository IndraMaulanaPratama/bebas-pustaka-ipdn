...
<div>
            ...
            <td>
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-12 col-xs-12">
                        <button type="button" class="btn btn-outline-secondary btn-sm" {{ $buttonAjukan }}
    ...
    <x-admin.components.modal.modal id='formPengajuanUlang'>
        ...
        <div class="modal-body">
            <form wire:submit='pengajuanUlang'>
                <div class="row g-4">

                    <x-admin.components.form.input name='inputUrl' placeholder='Tautan menuju konten lliterasi' />
