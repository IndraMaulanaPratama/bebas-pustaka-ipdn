...
<head>
    ...
    <title>Donasi Elektronik Perpustakaan Pusat</title>
...
<body>
    ...
    <div
        ...
        {{-- Data Donasi --}}
        <div class="container">
            Telah melakukan donasi elektronik pada Aplikasi Digilib Praja dengan rincian transaksi sebagai berikut:

            <table style="width: 100%; border-style: none; padding:0px 0px;">
                <tr>
                    <td width="120px">Nama Akun</td>
                    <td>:</td>
                    <td></td>
                </tr>
                <tr>
