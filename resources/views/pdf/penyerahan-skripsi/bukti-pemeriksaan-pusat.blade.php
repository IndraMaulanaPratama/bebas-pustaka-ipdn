    ...
    <div
        ...
        <div class="container">
            ...
            <ol type="1">
                ...
                <li>
                    1 (satu) dokumen <i>softcopy</i> (PDF) skripsi melalui email: <i>perpustakaan@ipdn.ac.id</i> dengan
                    Subjek Email: <b>NPP_Nama_Kelas_JudulSkripsi</b>
                </li>
            </ol>

            <p>
                pada hari ini {{ Carbon::now('Asia/Jakarta')->isoFormat('dddd') }} , tanggal
                {{ Carbon::now('Asia/Jakarta')->isoFormat('D MMMM Y') }} di Unit Perpustakaan Pusat Jatinangor atas
                nama:
            </p>
        </div>
