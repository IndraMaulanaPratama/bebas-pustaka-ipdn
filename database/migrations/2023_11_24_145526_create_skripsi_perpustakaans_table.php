...
return new class extends Migration {
    ...
    {
        Schema::create('SKRIPSI_PERPUSTAKAAN', function (Blueprint $table) {
            $table->string('SKRIPSI_ID', 36)->primary()->comment('Primary Key untuk table hard copy skripsi perpustakaan');
            $table->string('SKRIPSI_PRAJA', 8)->comment('Foreign Key ke data praja');
            $table->string('SKRIPSI_FAKULTAS', 3)->comment('Data fakultas praja');
    ...
    {
        Schema::dropIfExists('SKRIPSI_PERPUSTAKAAN');
    }
};
