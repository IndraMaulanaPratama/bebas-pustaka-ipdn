...
return new class extends Migration
{
    ...
    {
        Schema::create('PINJAMAN_FAKULTAS', function (Blueprint $table) {
            $table->string('FAKULTAS_ID', 36)->primary()->comment('Primary Key untuk table bebas pinjaman fakultas');
    ...
    {
        Schema::dropIfExists('PINJAMAN_FAKULTAS');
    }
};
